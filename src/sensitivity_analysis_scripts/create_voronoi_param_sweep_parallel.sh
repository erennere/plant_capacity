...
#SBATCH --output=logs/voronoi_parallel_sweep_%A_%a.out
#SBATCH --error=logs/voronoi_parallel_sweep_%A_%a.err
...
init_log "voronoi_parallel_sweep_${TASK_ID}"
enable_err_trap
rm -f "${LOG_DIR}"/voronoi_parallel_sweep_*.out \
