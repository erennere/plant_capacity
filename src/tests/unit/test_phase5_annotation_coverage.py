...
try:
    ...
    from src.annotation_scripts import NEW_03_WASTEWATERJOIN_GEOJSON as wwtp_join
    from src.annotation_scripts import download_bing_annotate as bing_annotate
except ImportError:
    import sys
