...
try:
    ...
    from src.pop_at_risk_river_calculations import find_intersection_river
...
class TestOrchestrationRiverAssignment:
    ...
    @patch('src.pop_at_risk_river_calculations.find_intersection_river.ProcessPoolExecutor')
...
class TestPipelinesOrchestration:
    ...
    @patch('src.pipelines.run_voronoi_approach')
...
class TestConfigurationValidation:
    ...
    def test_load_config_returns_dict(self, mock_load):
        ...
        result = starter.load_config(script_name="create_voronoi")
    ...
    def test_pipelines_resolve_configured_callable(self):
        ...
        import src.create_voronoi as cv_module
