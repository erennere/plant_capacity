...
- download_pop.py (32.3% → target 40%+)
- industrial_analysis/download_and_vectorize.py (34.7% → target 45%+)
- create_rasters.py orchestration (42.9% → target 50%+)
"""
...
# Imports
import research_code.download_pop as dp
...
class TestDownloadAndVectorizeLogic:
    ...
    @patch('research_code.industrial_analysis.download_and_vectorize.Path')
