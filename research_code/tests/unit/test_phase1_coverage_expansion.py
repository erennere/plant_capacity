...
from research_code.starter import parse_config_overrides, load_config
...
class TestRasterizeCsvGridLogic:
    ...
    def test_rasterize_csv_grid_construction(self):
        ...
        with patch("research_code.download_pop.rasterio.features.rasterize") as mock_rasterize:
