...
from research_code.annotation_scripts import NEW_01_GENERATEGRIDS as n1
from research_code.annotation_scripts import NEW_02_EXTRACTOSMDATAFULL_GEOJSON as n2
from research_code.annotation_scripts import NEW_03_WASTEWATERJOIN_GEOJSON as ww3
...
def test_download_bing_main_smoke(monkeypatch, tmp_path):
    ...
    runpy.run_module("research_code.annotation_scripts.download_bing_annotate", run_name="__main__")
...
def test_new01_main_script_smoke(monkeypatch, tmp_path):
    ...
    runpy.run_module("research_code.annotation_scripts.NEW_01_GENERATEGRIDS", run_name="__main__")
...
def test_new03_script_skips_main_when_output_file_missing(monkeypatch, tmp_path):
    ...
    runpy.run_module("research_code.annotation_scripts.NEW_03_WASTEWATERJOIN_GEOJSON", run_name="__main__")
