...
Utilities and pipelines for plant capacity spatial analysis.

This package is installed from the `research_code/` directory and exposes
modules used by the project scripts.
